...
int Game::Start(int argc, char** argv) {
    ...
    box = new Box(cache, world, 640, 300, 50, 50);
    box2 = new Box(cache, world, 660, 100, 50, 50);
    debug_ground = new Tile(cache, world, "resources/sprites/debug-block.bmp", 490, 700, 700, 49);
